...
# Portions copyright (C) 2011 Brian Kyckelhahn
#
...
#        self.Bind(wx.EVT_ENTER_WINDOW,                            #Brian commented
...
#            gc.SetTextForeground(self._color['htxt']) # Brian
            gc.SetPen(wx.TRANSPARENT_PEN)
